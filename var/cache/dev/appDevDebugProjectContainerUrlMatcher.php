...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($rawPathinfo.'/', 'front');
            }
        ...
        if (0 === strpos($pathinfo, '/mail')) {
            // vsya_pochta
            if ('/mail' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\MailController::indexAction',  '_route' => 'vsya_pochta',);
            }

            // compose
            if ('/mail/compose' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\MailController::composeAction',  '_route' => 'compose',);
            }

            // mail_sent
            if ('/mail/sent' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\MailController::sentAction',  '_route' => 'mail_sent',);
            }

            // avtorizaciya
            if ('/mail/avtorizaciya' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\MailController::avtorizaciyaAction',  '_route' => 'avtorizaciya',);
            }

            // korzina
            if ('/mail/korzina' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\MailController::korzinaAction',  '_route' => 'korzina',);
            }

            // mail_delete
            if (0 === strpos($pathinfo, '/mail/delete') && preg_match('#^/mail/delete(?:/(?P<id>\\d+))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mail_delete')), array (  'id' => 1,  '_controller' => 'AppBundle\\Controller\\MailController::deleteAction',));
            }

            // download_file
            if (0 === strpos($pathinfo, '/mail/download') && preg_match('#^/mail/download/(?P<filename>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'download_file')), array (  '_controller' => 'AppBundle\\Controller\\MailController::downloadAction',));
            }
